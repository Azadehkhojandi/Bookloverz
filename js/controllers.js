...
myApp.controller('AroundMe', [
    ...
    function ($rootScope, $scope, UserInteractionService) {
        ...
        $rootScope.$on('coordinate:updated', function () {
            ...
            var users = UserInteractionService.UserNearby();

            var users1 = UserInteractionService.UserNearbyPOST();
        });
...
// myApp.controller('mainCtrl', ['$scope', 'CurrentUserService', 'geolocation', function ($scope, CurrentUserService, geolocation) {
//     geolocation.getLocation().then(function(data){
//             CurrentUserService.lat = data.coords.latitude;
//         CurrentUserService.long = data.coords.longitude;
//         CurrentUserService.UpdateCoordinate({ lat: data.coords.latitude, long: data.coords.longitude });
